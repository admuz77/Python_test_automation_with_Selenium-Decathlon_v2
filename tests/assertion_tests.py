...
class AssertionTests(BasePage):
    ...
    def prices_comparison(self):
        ...
        for value in prices_list:
            print("Sortowanie według ceny rosnąco. Cena produktu sortowanego na stronie to", value)
        ...
        for verifity_value in verifity_prices_list:
            print("Sortowanie według ceny rosnąco. Cena produktu po weryfikacji sortowania to", verifity_value)
    ...
    def prices_comparison_reverse(self):
        ...
        prices_list = list(prices_float)
        for value in prices_list:
            print("Sortowanie według ceny malejąco. Cena produktu sortowanego na stronie to", value)
        ...
        for reversed_value in reversed_prices_list:
            print("Sortowanie według ceny malejąco. Cena produktu po weryfikacji sortowania to", reversed_value)
    ...
    def discounts_comparison(self):
        ...
        for value in discounts_list:
            print("Sortowanie według rabatu. Wysokość rabatu: ", value)
        ...
        for reversed_discounts_value in reversed_discounts_list:
            print("Sortowanie według rabatu. Rabat po weryfikacji sortowania to", reversed_discounts_value)
    ...
    def item_name_assertion(self):
        ...
        print(f'Nazwa przedmiotu wkładanego do koszyka:', first_name)
        ...
        print(f'Nazwa przedmiotu, który jest w koszyku:', second_name)
    ...
    def empty_basket_assertion(self):
        ...
        print(f'Napis widniejący po wyrzuceniu produktu z koszyka:', statement)
